...
@Component({
  ...
  styles: [`
    ...
    .card h3 { font-size: 1.1rem; font-weight: 700; color: #111827; margin-top: 0; margin-bottom: 1.25rem; }
    .setting-item { display: flex; justify-content: space-between; align-items: center; padding: 1rem 0; border-bottom: 1px solid #f3f4f6; }
    .setting-item:last-child { border-bottom: none; }
    .setting-item strong { display: block; font-size: 0.92rem; color: #111827; }
    .setting-item p { font-size: 0.8rem; color: #6b7280; margin: 0.15rem 0 0 0; }
  `]
})
